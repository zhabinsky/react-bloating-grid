...
function BloatingBase (props) {
  ...
  const gridRowGap = gridGap || propRowGap;
  const gridColumnGap = gridGap || propColumnGap;
...
const Bloating = withResolvedBreakpoints (BloatingBase, ['gridColumns']);
